 ...
 * 
 */
@WebServiceClient(name = "serviceService", targetNamespace = "urn:SandboxWebApi", wsdlLocation = "file:/E:/Scrappy%20Airsoft%20Shop/ScrappyAirsoftShop/xml-resources/web-service-references/service/wsdl/webapi.allegro.pl.webapisandbox.pl/service.php.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("urn:SandboxWebApi", "serviceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/E:/Scrappy%20Airsoft%20Shop/ScrappyAirsoftShop/xml-resources/web-service-references/service/wsdl/webapi.allegro.pl.webapisandbox.pl/service.php.wsdl");
    ...
    public ServicePort getServicePort() {
        return super.getPort(new QName("urn:SandboxWebApi", "servicePort"), ServicePort.class);
    }
    ...
    public ServicePort getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("urn:SandboxWebApi", "servicePort"), ServicePort.class, features);
    }
