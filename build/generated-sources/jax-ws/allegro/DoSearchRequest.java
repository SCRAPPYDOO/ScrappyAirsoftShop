 ...
 *         &lt;element name="searchQuery" type="{urn:SandboxWebApi}SearchOptType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DoSearchRequest")
public class DoSearchRequest {

    @XmlElement(required = true)
    protected String sessionHandle;
    @XmlElement(required = true)
    protected SearchOptType searchQuery;
     ...
     *     
     */
    public SearchOptType getSearchQuery() {
        return searchQuery;
    }
     ...
     *     
     */
    public void setSearchQuery(SearchOptType value) {
